    ...
    <div class = "row justify-content-center">
        ...
        <form action="process-index.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="txtEmail" id="email" placeholder="Enter email">
          </div>
          <div class="form-group">
            <label for="password" class="label">Password</label>
            <input type="password" class="form-control" name="txtPass" id="password" placeholder="Password">            
          </div>   
          <button type="submit" name="sbmGuiDi" class="btn btn-danger btn-block my-3">Login</button>
        </form>
        </div>
    </div>
